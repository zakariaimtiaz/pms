...
@Transactional
class ListPmAdditionalActionsActionService extends BaseService implements ActionServiceIntf {
    ...
    public Map execute(Map result) {
        try {
            ...
            Map resultMap = super.getSearchResult(result, ListPmAdditionalActionsActionServiceModel.class,additionalParam)

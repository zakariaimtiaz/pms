...
@Transactional
class GetDropDownServiceCategoryTaglibActionService extends BaseService implements ActionServiceIntf {
    ...
    public Map execute(Map result) {
        try {
            List<ServiceCategory> lstCategory = ServiceCategory.list()
     ...
     * @return - html string for select
     */
    private String buildDropDown(List<ServiceCategory> lstCategory, Map dropDownAttributes) {
        // read map values

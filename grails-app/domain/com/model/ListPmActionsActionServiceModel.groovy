...
class ListPmActionsActionServiceModel {
    ...
    public static final String SQL_LIST_ACTIONS_MODEL = """
            CREATE OR REPLACE VIEW list_pm_actions_action_service_model AS
             ...
             SELECT d.id, d.version,d.actions,d.is_editable, g.id AS goal_id, g.goal,d.res_person_id,d.start, d.end,COALESCE(d.extended_end,'') extended_end,d.sequence, d.tmp_seq, sc.id AS service_id,sc.name AS service,

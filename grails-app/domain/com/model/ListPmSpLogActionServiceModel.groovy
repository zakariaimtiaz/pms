...
class ListPmSpLogActionServiceModel {
    ...
    public static final String SQL_LIST_PM_SP_LOG_MODEL = """
        ...
        SELECT spl.id,spl.version,spl.year,sc.id AS service_id,sc.name AS service_name,sc.short_name AS service,
        spl.sp_time_schedule_id,spl.is_submitted,spl.is_editable,spl.submission_date,spl.dead_line

...
grails.plugin.springsecurity.userLookup.userDomainClassName = 'com.pms.SecUser'
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'com.pms.SecUserSecRole'
grails.plugin.springsecurity.authority.className = 'com.pms.SecRole'
grails.plugin.springsecurity.requestMap.className = 'com.pms.FeatureManagement'

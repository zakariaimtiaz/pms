...
<nav id="navbar" class="navbar navbar-default navbar-static-top" role="navigation"
    ...
    <ul class="nav navbar-top-links navbar-right">
        <!-- /.dropdown -->
        <li class="dropdown">
    <li style="text-align: center">Welcome &nbsp;<strong><font color="green"> <sec:fullName property='fullName'></sec:fullName>&nbsp;</font></strong></li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <sec:access url="/pmServiceSector/show">
                                <li>
                                    <a href="#pmServiceSector/show"><i class="fa fa-cog"></i>&nbsp;Central Service/Sector</a>
                                </li>
                            </sec:access>

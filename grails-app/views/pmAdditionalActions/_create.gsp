        ...
        <div id="application_top_panel" class="panel panel-primary">
            ...
            <g:form name='actionForm' id='actionForm' class="form-horizontal form-widgets" role="form">
                <div class="panel-body">
                    ...
                    <input type="hidden" name="hfSubmissionDate" id="hfSubmissionDate"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" id="start" name="start" tabindex="3"
                                   data-bind="value: actions.start" placeholder="Select month">
                            %{--<input type="text" id="end" name="end" tabindex="4" style="display: none;"
